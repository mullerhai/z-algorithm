...
object OfficialLR4 {
  def main(args: Array[String]): Unit = {
    ...
    val stringIndexInputColumns = Array[String]("city", "ad_id", "material_id", "device","cur_app_id","channel")
    ...
    val onehotInputColumns = Array("si_city", "si_ad_id", "si_material_id", "si_device", "binary_skip_ad_times","si_cur_app_id","si_channel")
