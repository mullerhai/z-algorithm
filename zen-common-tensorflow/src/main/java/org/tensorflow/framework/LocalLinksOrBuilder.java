...
public interface LocalLinksOrBuilder extends
   ...
   */
  java.util.List<InterconnectLink>
      getLinkList();
  /**
   * <code>repeated .tensorflow.InterconnectLink link = 1;</code>
   */
  InterconnectLink getLink(int index);
  /**
   * <code>repeated .tensorflow.InterconnectLink link = 1;</code>
   */
  int getLinkCount();
   ...
   * <code>repeated .tensorflow.InterconnectLink link = 1;</code>
   */
  java.util.List<? extends InterconnectLinkOrBuilder>
      getLinkOrBuilderList();
  /**
   * <code>repeated .tensorflow.InterconnectLink link = 1;</code>
   */
  InterconnectLinkOrBuilder getLinkOrBuilder(
          int index);
}
