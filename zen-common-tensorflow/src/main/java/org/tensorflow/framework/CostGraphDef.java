...
import org.tensorflow.util.IntArrayList;
...
private static final long serialVersionUID = 0L;
  ...
  private CostGraphDef(
    ...
    try {
      ...
      if (((mutable_bitField0_ & 0x00000001) != 0)) {
        node_ = Collections.unmodifiableList(node_);
      }
  ...
  private static final long serialVersionUID = 0L;
    ...
    private Node() {
      name_ = "";
      device_ = "";
      inputInfo_ = Collections.emptyList();
      outputInfo_ = Collections.emptyList();
      controlInput_ = IntArrayList.emptyList();
    }
    ...
    private Node(
      ...
      try {
        ...
        if (((mutable_bitField0_ & 0x00000008) != 0)) {
          inputInfo_ = Collections.unmodifiableList(inputInfo_);
        }
        if (((mutable_bitField0_ & 0x00000010) != 0)) {
          outputInfo_ = Collections.unmodifiableList(outputInfo_);
        }
        if (((mutable_bitField0_ & 0x00004000) != 0)) {
    ...
    private IntArrayList controlInput_;
    /**
     * <pre>
     * Ids of the control inputs for this node.
     * </pre>
  ...
  checkByteStringIsUtf8(value);
      ...
      public java.util.List<InputInfo> getInputInfoList() {
        if (inputInfoBuilder_ == null) {
          return Collections.unmodifiableList(inputInfo_);
        } else {
      ...
      public java.util.List<OutputInfo> getOutputInfoList() {
        if (outputInfoBuilder_ == null) {
          return Collections.unmodifiableList(outputInfo_);
        } else {
       ...
       * <code>int64 host_temp_memory_size = 10 [deprecated = true];</code>
       */
      @Deprecated public Builder setHostTempMemorySize(long value) {
       ...
       * <code>int64 host_temp_memory_size = 10 [deprecated = true];</code>
       */
      @Deprecated public Builder clearHostTempMemorySize() {
      ...
      private IntArrayList controlInput_ = IntArrayList.emptyList();
      private void ensureControlInputIsMutable() {
        if (!((bitField0_ & 0x00004000) != 0)) {
          controlInput_ = controlInput_.mutableCopyWithCapacity(controlInput_.size());
      ...
      public java.util.List<Integer>
        ...
        return ((bitField0_ & 0x00004000) != 0) ?
                 Collections.unmodifiableList(controlInput_) : controlInput_;
      }
      /**
       * <pre>
       * Ids of the control inputs for this node.
  ...
  public static final class Builder extends
    ...
    public java.util.List<Node> getNodeList() {
      if (nodeBuilder_ == null) {
        return Collections.unmodifiableList(node_);
      } else {
