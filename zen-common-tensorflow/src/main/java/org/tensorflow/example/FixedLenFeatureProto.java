...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ExampleParserConfigurationProtos.internal_static_tensorflow_FixedLenFeatureProto_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ExampleParserConfigurationProtos.internal_static_tensorflow_FixedLenFeatureProto_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            FixedLenFeatureProto.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof FixedLenFeatureProto)) {
      return super.equals(obj);
    }
    FixedLenFeatureProto other = (FixedLenFeatureProto) obj;
  ...
  public static FixedLenFeatureProto parseFrom(
  ...
  public static FixedLenFeatureProto parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static FixedLenFeatureProto parseFrom(
  ...
  public static FixedLenFeatureProto parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static FixedLenFeatureProto parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static FixedLenFeatureProto parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(FixedLenFeatureProto prototype) {
  ...
  public static final class Builder extends
    ...
    public FixedLenFeatureProto build() {
      FixedLenFeatureProto result = buildPartial();
    ...
    public FixedLenFeatureProto buildPartial() {
      FixedLenFeatureProto result = new FixedLenFeatureProto(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof FixedLenFeatureProto) {
        return mergeFrom((FixedLenFeatureProto)other);
      } else {
    ...
    public Builder mergeFrom(FixedLenFeatureProto other) {
      if (other == FixedLenFeatureProto.getDefaultInstance()) return this;
      if (other.dtype_ != 0) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      FixedLenFeatureProto parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (FixedLenFeatureProto) e.getUnfinishedMessage();
  ...
  private static final FixedLenFeatureProto DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new FixedLenFeatureProto();
  }
