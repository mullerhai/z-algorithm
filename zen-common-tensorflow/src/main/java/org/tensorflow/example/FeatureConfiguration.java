...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            FixedLenFeatureProto.Builder subBuilder = null;
            if (configCase_ == 1) {
              subBuilder = ((FixedLenFeatureProto) config_).toBuilder();
            }
            config_ =
                input.readMessage(FixedLenFeatureProto.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((FixedLenFeatureProto) config_);
          ...
          case 18: {
            VarLenFeatureProto.Builder subBuilder = null;
            if (configCase_ == 2) {
              subBuilder = ((VarLenFeatureProto) config_).toBuilder();
            }
            config_ =
                input.readMessage(VarLenFeatureProto.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((VarLenFeatureProto) config_);
              config_ = subBuilder.buildPartial();
            }
            configCase_ = 2;
            break;
  ...
  protected FieldAccessorTable
    ...
    return ExampleParserConfigurationProtos.internal_static_tensorflow_FeatureConfiguration_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            FeatureConfiguration.class, Builder.class);
  }
  ...
  public FixedLenFeatureProto getFixedLenFeature() {
    if (configCase_ == 1) {
       return (FixedLenFeatureProto) config_;
    }
    return FixedLenFeatureProto.getDefaultInstance();
  }
  /**
   * <code>.tensorflow.FixedLenFeatureProto fixed_len_feature = 1;</code>
   */
  ...
  public VarLenFeatureProto getVarLenFeature() {
    if (configCase_ == 2) {
       return (VarLenFeatureProto) config_;
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (configCase_ == 1) {
      output.writeMessage(1, (FixedLenFeatureProto) config_);
    }
    if (configCase_ == 2) {
      output.writeMessage(2, (VarLenFeatureProto) config_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (configCase_ == 1) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, (FixedLenFeatureProto) config_);
    }
    if (configCase_ == 2) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(2, (VarLenFeatureProto) config_);
    }
  ...
  public static FeatureConfiguration parseFrom(
  ...
  public static FeatureConfiguration parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static FeatureConfiguration parseFrom(
  ...
  public static FeatureConfiguration parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static FeatureConfiguration parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static FeatureConfiguration parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(FeatureConfiguration prototype) {
  ...
  public static final class Builder extends
    ...
    public FeatureConfiguration build() {
      FeatureConfiguration result = buildPartial();
    ...
    public FeatureConfiguration buildPartial() {
      FeatureConfiguration result = new FeatureConfiguration(this);
      if (configCase_ == 1) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof FeatureConfiguration) {
        return mergeFrom((FeatureConfiguration)other);
      } else {
    ...
    public Builder mergeFrom(FeatureConfiguration other) {
      if (other == FeatureConfiguration.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      FeatureConfiguration parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (FeatureConfiguration) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        FixedLenFeatureProto, FixedLenFeatureProto.Builder, FixedLenFeatureProtoOrBuilder> fixedLenFeatureBuilder_;
    /**
     * <code>.tensorflow.FixedLenFeatureProto fixed_len_feature = 1;</code>
     */
    public boolean hasFixedLenFeature() {
     ...
     * <code>.tensorflow.FixedLenFeatureProto fixed_len_feature = 1;</code>
     */
    public Builder setFixedLenFeature(FixedLenFeatureProto value) {
      if (fixedLenFeatureBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setFixedLenFeature(
        FixedLenFeatureProto.Builder builderForValue) {
      if (fixedLenFeatureBuilder_ == null) {
     ...
     * <code>.tensorflow.FixedLenFeatureProto fixed_len_feature = 1;</code>
     */
    public Builder mergeFixedLenFeature(FixedLenFeatureProto value) {
      if (fixedLenFeatureBuilder_ == null) {
        if (configCase_ == 1 &&
            config_ != FixedLenFeatureProto.getDefaultInstance()) {
          config_ = FixedLenFeatureProto.newBuilder((FixedLenFeatureProto) config_)
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        FixedLenFeatureProto, FixedLenFeatureProto.Builder, FixedLenFeatureProtoOrBuilder>
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        VarLenFeatureProto, VarLenFeatureProto.Builder, VarLenFeatureProtoOrBuilder> varLenFeatureBuilder_;
    /**
     * <code>.tensorflow.VarLenFeatureProto var_len_feature = 2;</code>
     */
    public boolean hasVarLenFeature() {
     ...
     * <code>.tensorflow.VarLenFeatureProto var_len_feature = 2;</code>
     */
    public Builder setVarLenFeature(VarLenFeatureProto value) {
      if (varLenFeatureBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setVarLenFeature(
        VarLenFeatureProto.Builder builderForValue) {
      if (varLenFeatureBuilder_ == null) {
        config_ = builderForValue.build();
        onChanged();
      } else {
     ...
     * <code>.tensorflow.VarLenFeatureProto var_len_feature = 2;</code>
     */
    public Builder mergeVarLenFeature(VarLenFeatureProto value) {
      if (varLenFeatureBuilder_ == null) {
        if (configCase_ == 2 &&
            config_ != VarLenFeatureProto.getDefaultInstance()) {
          config_ = VarLenFeatureProto.newBuilder((VarLenFeatureProto) config_)
              .mergeFrom(value).buildPartial();
        } else {
          config_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        VarLenFeatureProto, VarLenFeatureProto.Builder, VarLenFeatureProtoOrBuilder>
  ...
  private static final FeatureConfiguration DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new FeatureConfiguration();
  }
