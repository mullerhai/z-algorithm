...
public final class FeatureProtos {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return FeatureProtos.internal_static_angel_serving_BytesList_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return FeatureProtos.internal_static_angel_serving_BytesList_fieldAccessorTable
    ...
    public static final class Builder extends
      ...
      // Construct using FeatureProtos.BytesList.newBuilder()
      private Builder() {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return FeatureProtos.internal_static_angel_serving_FloatList_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return FeatureProtos.internal_static_angel_serving_FloatList_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
    ...
    public static final class Builder extends
      ...
      // Construct using FeatureProtos.FloatList.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return FeatureProtos.internal_static_angel_serving_Int64List_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return FeatureProtos.internal_static_angel_serving_Int64List_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
    ...
    public static final class Builder extends
      ...
      // Construct using FeatureProtos.Int64List.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return FeatureProtos.internal_static_angel_serving_Feature_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return FeatureProtos.internal_static_angel_serving_Feature_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
    ...
    public static final class Builder extends
      ...
      // Construct using FeatureProtos.Feature.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              com.google.protobuf.MapEntry<String, Feature>
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return FeatureProtos.internal_static_angel_serving_Features_descriptor;
    }
    ...
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return FeatureProtos.internal_static_angel_serving_Features_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
    ...
    private static final class FeatureDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          String, Feature> defaultEntry =
              com.google.protobuf.MapEntry
              .<String, Feature>newDefaultInstance(
                  FeatureProtos.internal_static_angel_serving_Features_FeatureEntry_descriptor, 
    ...
    private com.google.protobuf.MapField<
        String, Feature> feature_;
    private com.google.protobuf.MapField<String, Feature>
    internalGetFeature() {
      if (feature_ == null) {
     ...
     */
    @Deprecated
    public java.util.Map<String, Feature> getFeature() {
    ...
    public java.util.Map<String, Feature> getFeatureMap() {
    ...
    public Feature getFeatureOrDefault(
        String key,
        Feature defaultValue) {
      if (key == null) { throw new NullPointerException(); }
      java.util.Map<String, Feature> map =
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      for (java.util.Map.Entry<String, Feature> entry
    ...
    public static final class Builder extends
      ...
      // Construct using FeatureProtos.Features.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Builder putAllFeature(
          java.util.Map<String, Feature> values) {
        internalGetMutableFeature().getMutableMap()
            .putAll(values);
        return this;
      }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return FeatureProtos.internal_static_angel_serving_FeatureList_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return FeatureProtos.internal_static_angel_serving_FeatureList_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              FeatureList.class, Builder.class);
    }
    ...
    public static FeatureList parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static FeatureList parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static FeatureList parseFrom(
    ...
    public static FeatureList parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static FeatureList parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static FeatureList parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(FeatureList prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
      ...
      // Construct using FeatureProtos.FeatureList.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public FeatureList build() {
        FeatureList result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public FeatureList buildPartial() {
        FeatureList result = new FeatureList(this);
        int from_bitField0_ = bitField0_;
        if (featureBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001)) {
            feature_ = java.util.Collections.unmodifiableList(feature_);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof FeatureList) {
          return mergeFrom((FeatureList)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(FeatureList other) {
        if (other == FeatureList.getDefaultInstance()) return this;
        if (featureBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        FeatureList parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (FeatureList) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    static {
      DEFAULT_INSTANCE = new FeatureList();
    }
  ...
  public interface FeatureListsOrBuilder extends
     ...
     */
    @Deprecated
    java.util.Map<String, FeatureList>
    getFeatureList();
    /**
     * <pre>
     * Map from feature name to feature list.
    ...
    FeatureList getFeatureListOrDefault(
            String key,
    ...
    FeatureList getFeatureListOrThrow(
            String key);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return FeatureProtos.internal_static_angel_serving_FeatureLists_descriptor;
    }
    ...
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return FeatureProtos.internal_static_angel_serving_FeatureLists_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
      ...
      static final com.google.protobuf.MapEntry<
          String, FeatureList> defaultEntry =
              ...
              .<String, FeatureList>newDefaultInstance(
                  FeatureProtos.internal_static_angel_serving_FeatureLists_FeatureListEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.STRING,
                  "",
                  com.google.protobuf.WireFormat.FieldType.MESSAGE,
    ...
    public static final class Builder extends
      ...
      // Construct using FeatureProtos.FeatureLists.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  static {
    ...
    internal_static_angel_serving_Feature_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_angel_serving_Feature_descriptor,
        new String[] { "BytesList", "FloatList", "Int64List", "Kind", });
    internal_static_angel_serving_Features_descriptor =
