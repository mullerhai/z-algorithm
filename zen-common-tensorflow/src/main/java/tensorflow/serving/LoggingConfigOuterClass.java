...
public final class LoggingConfigOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected FieldAccessorTable
      ...
      return LoggingConfigOuterClass.internal_static_tensorflow_serving_SamplingConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SamplingConfig.class, Builder.class);
    }
    ...
    public static SamplingConfig parseFrom(
    ...
    public static SamplingConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SamplingConfig parseFrom(
    ...
    public static SamplingConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SamplingConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SamplingConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(SamplingConfig prototype) {
    ...
    public static final class Builder extends
      ...
      public SamplingConfig build() {
        SamplingConfig result = buildPartial();
      ...
      public SamplingConfig buildPartial() {
        SamplingConfig result = new SamplingConfig(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SamplingConfig) {
          return mergeFrom((SamplingConfig)other);
        } else {
      ...
      public Builder mergeFrom(SamplingConfig other) {
        if (other == SamplingConfig.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        SamplingConfig parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SamplingConfig) e.getUnfinishedMessage();
    ...
    static {
      DEFAULT_INSTANCE = new SamplingConfig();
    }
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              SamplingConfig.Builder subBuilder = null;
              if (samplingConfig_ != null) {
                subBuilder = samplingConfig_.toBuilder();
              }
              samplingConfig_ = input.readMessage(SamplingConfig.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    protected FieldAccessorTable
      ...
      return LoggingConfigOuterClass.internal_static_tensorflow_serving_LoggingConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              LoggingConfig.class, Builder.class);
    }
    ...
    public SamplingConfig getSamplingConfig() {
      return samplingConfig_ == null ? SamplingConfig.getDefaultInstance() : samplingConfig_;
    }
    /**
     * <code>.tensorflow.serving.SamplingConfig sampling_config = 2;</code>
     */
    ...
    public static LoggingConfig parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static LoggingConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static LoggingConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static LoggingConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(LoggingConfig prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
      ...
      public LoggingConfig build() {
        LoggingConfig result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public LoggingConfig buildPartial() {
        LoggingConfig result = new LoggingConfig(this);
        if (logCollectorConfigBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof LoggingConfig) {
          return mergeFrom((LoggingConfig)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(LoggingConfig other) {
        if (other == LoggingConfig.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        LoggingConfig parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (LoggingConfig) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
       ...
       * <code>.tensorflow.serving.SamplingConfig sampling_config = 2;</code>
       */
      public Builder setSamplingConfig(SamplingConfig value) {
        if (samplingConfigBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setSamplingConfig(
          SamplingConfig.Builder builderForValue) {
        if (samplingConfigBuilder_ == null) {
       ...
       * <code>.tensorflow.serving.SamplingConfig sampling_config = 2;</code>
       */
      public Builder mergeSamplingConfig(SamplingConfig value) {
        if (samplingConfigBuilder_ == null) {
          if (samplingConfig_ != null) {
            samplingConfig_ =
              SamplingConfig.newBuilder(samplingConfig_).mergeFrom(value).buildPartial();
          } else {
            samplingConfig_ = value;
          }
          onChanged();
      ...
      public SamplingConfigOrBuilder getSamplingConfigOrBuilder() {
        if (samplingConfigBuilder_ != null) {
          ...
          return samplingConfig_ == null ?
              SamplingConfig.getDefaultInstance() : samplingConfig_;
        }
      }
      /**
       * <code>.tensorflow.serving.SamplingConfig sampling_config = 2;</code>
