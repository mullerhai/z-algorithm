...
public final class ModelServerConfigOuterClass {
  ...
  public interface ModelConfigOrBuilder extends
     ...
     * <code>.tensorflow.serving.ModelType model_type = 3 [deprecated = true];</code>
     */
    @Deprecated ModelType getModelType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected FieldAccessorTable
      ...
      return ModelServerConfigOuterClass.internal_static_tensorflow_serving_ModelConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ModelConfig.class, Builder.class);
    }
     ...
     * <code>.tensorflow.serving.ModelType model_type = 3 [deprecated = true];</code>
     */
    @Deprecated public ModelType getModelType() {
      @SuppressWarnings("deprecation")
      ModelType result = ModelType.valueOf(modelType_);
      return result == null ? ModelType.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (modelType_ != ModelType.MODEL_TYPE_UNSPECIFIED.getNumber()) {
    ...
    public static ModelConfig parseFrom(
    ...
    public static ModelConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ModelConfig parseFrom(
    ...
    public static ModelConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ModelConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ModelConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ModelConfig prototype) {
    ...
    public static final class Builder extends
      ...
      public ModelConfig build() {
        ModelConfig result = buildPartial();
      ...
      @Override
      public ModelConfig buildPartial() {
        ModelConfig result = new ModelConfig(this);
        result.name_ = name_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ModelConfig) {
          return mergeFrom((ModelConfig)other);
        } else {
      ...
      public Builder mergeFrom(ModelConfig other) {
        if (other == ModelConfig.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ModelConfig parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ModelConfig) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
       ...
       * <code>.tensorflow.serving.ModelType model_type = 3 [deprecated = true];</code>
       */
      @Deprecated public Builder setModelType(ModelType value) {
        if (value == null) {
          throw new NullPointerException();
        }
  ...
  checkByteStringIsUtf8(value);
    ...
    static {
      DEFAULT_INSTANCE = new ModelConfig();
    }
  ...
  public interface ModelConfigListOrBuilder extends
     ...
     * <code>repeated .tensorflow.serving.ModelConfig config = 1;</code>
     */
    ModelConfig getConfig(int index);
    /**
     * <code>repeated .tensorflow.serving.ModelConfig config = 1;</code>
     */
    int getConfigCount();
     ...
     * <code>repeated .tensorflow.serving.ModelConfig config = 1;</code>
     */
    ModelConfigOrBuilder getConfigOrBuilder(
            int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              config_.add(
                  input.readMessage(ModelConfig.parser(), extensionRegistry));
              break;
            }
            default: {
              if (!parseUnknownField(
    ...
    protected FieldAccessorTable
      ...
      return ModelServerConfigOuterClass.internal_static_tensorflow_serving_ModelConfigList_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ModelConfigList.class, Builder.class);
    }
     ...
     * <code>repeated .tensorflow.serving.ModelConfig config = 1;</code>
     */
    public ModelConfig getConfig(int index) {
      return config_.get(index);
    }
    /**
     * <code>repeated .tensorflow.serving.ModelConfig config = 1;</code>
     */
    public ModelConfigOrBuilder getConfigOrBuilder(
        int index) {
      return config_.get(index);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      ModelConfigList other = (ModelConfigList) obj;
    ...
    public static ModelConfigList parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static ModelConfigList parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ModelConfigList parseFrom(
    ...
    public static ModelConfigList parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static ModelConfigList parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ModelConfigList parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ModelConfigList prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
      ...
      @Override
      public ModelConfigList getDefaultInstanceForType() {
        return ModelConfigList.getDefaultInstance();
      }

      @Override
      public ModelConfigList build() {
        ModelConfigList result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @Override
      public ModelConfigList buildPartial() {
        ModelConfigList result = new ModelConfigList(this);
      ...
      @Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ModelConfigList) {
          return mergeFrom((ModelConfigList)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(ModelConfigList other) {
        if (other == ModelConfigList.getDefaultInstance()) return this;
        if (configBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ModelConfigList parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ModelConfigList) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
       ...
       */
      public Builder setConfig(
          int index, ModelConfig.Builder builderForValue) {
        if (configBuilder_ == null) {
          ensureConfigIsMutable();
       ...
       * <code>repeated .tensorflow.serving.ModelConfig config = 1;</code>
       */
      public Builder addConfig(ModelConfig value) {
        if (configBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addConfig(
          ModelConfig.Builder builderForValue) {
        if (configBuilder_ == null) {
          ensureConfigIsMutable();
       ...
       * <code>repeated .tensorflow.serving.ModelConfig config = 1;</code>
       */
      public ModelConfig.Builder getConfigBuilder(
          int index) {
      ...
      public ModelConfig.Builder addConfigBuilder() {
        return getConfigFieldBuilder().addBuilder(
            ModelConfig.getDefaultInstance());
      }
      /**
       * <code>repeated .tensorflow.serving.ModelConfig config = 1;</code>
       */
      public ModelConfig.Builder addConfigBuilder(
          int index) {
        return getConfigFieldBuilder().addBuilder(
            index, ModelConfig.getDefaultInstance());
      }
      /**
       * <code>repeated .tensorflow.serving.ModelConfig config = 1;</code>
       */
    ...
    static {
      DEFAULT_INSTANCE = new ModelConfigList();
    }
  ...
  public interface ModelServerConfigOrBuilder extends
    ...
    public ModelServerConfig.ConfigCase getConfigCase();
  }
  /**
   * <pre>
   * ModelServer config.
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              ModelConfigList.Builder subBuilder = null;
              if (configCase_ == 1) {
                subBuilder = ((ModelConfigList) config_).toBuilder();
              }
              config_ =
                  input.readMessage(ModelConfigList.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((ModelConfigList) config_);
    ...
    protected FieldAccessorTable
      ...
      return ModelServerConfigOuterClass.internal_static_tensorflow_serving_ModelServerConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ModelServerConfig.class, Builder.class);
    }
    ...
    public ModelConfigList getModelConfigList() {
      if (configCase_ == 1) {
         return (ModelConfigList) config_;
      }
      return ModelConfigList.getDefaultInstance();
    }
    /**
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (configCase_ == 1) {
        output.writeMessage(1, (ModelConfigList) config_);
      }
      if (configCase_ == 2) {
    ...
    public int getSerializedSize() {
      ...
      if (configCase_ == 1) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, (ModelConfigList) config_);
      }
      if (configCase_ == 2) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final Object obj) {
      ...
      ModelServerConfig other = (ModelServerConfig) obj;
    ...
    public static ModelServerConfig parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static ModelServerConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ModelServerConfig parseFrom(
    ...
    public static ModelServerConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static ModelServerConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ModelServerConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ModelServerConfig prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
      ...
      @Override
      public ModelServerConfig getDefaultInstanceForType() {
        return ModelServerConfig.getDefaultInstance();
      }

      @Override
      public ModelServerConfig build() {
        ModelServerConfig result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @Override
      public ModelServerConfig buildPartial() {
        ModelServerConfig result = new ModelServerConfig(this);
        if (configCase_ == 1) {
      ...
      @Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ModelServerConfig) {
          return mergeFrom((ModelServerConfig)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(ModelServerConfig other) {
        if (other == ModelServerConfig.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ModelServerConfig parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ModelServerConfig) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
       ...
       * <code>.tensorflow.serving.ModelConfigList model_config_list = 1;</code>
       */
      public Builder setModelConfigList(ModelConfigList value) {
        if (modelConfigListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setModelConfigList(
          ModelConfigList.Builder builderForValue) {
        if (modelConfigListBuilder_ == null) {
       ...
       * <code>.tensorflow.serving.ModelConfigList model_config_list = 1;</code>
       */
      public Builder mergeModelConfigList(ModelConfigList value) {
        if (modelConfigListBuilder_ == null) {
          if (configCase_ == 1 &&
              config_ != ModelConfigList.getDefaultInstance()) {
            config_ = ModelConfigList.newBuilder((ModelConfigList) config_)
    ...
    static {
      DEFAULT_INSTANCE = new ModelServerConfig();
    }
  ...
  static {
    String[] descriptorData = {
      ...
      "m_storage_path_source.proto\"\251\002\n\013ModelCon" +
      ...
      ".ServableVersionPolicy\0229\n\016logging_config" +
      "\030\006 \001(\0132!.tensorflow.serving.LoggingConfi" +
      "gJ\004\010\005\020\006\"B\n\017ModelConfigList\022/\n\006config\030\001 \003" +
      "(\0132\037.tensorflow.serving.ModelConfig\"\224\001\n\021" +
      "ModelServerConfig\022@\n\021model_config_list\030\001" +
      " \001(\0132#.tensorflow.serving.ModelConfigLis" +
      "tH\000\0223\n\023custom_model_config\030\002 \001(\0132\024.googl" +
      "e.protobuf.AnyH\000B\010\n\006config*N\n\tModelType\022" +
      "\036\n\026MODEL_TYPE_UNSPECIFIED\020\000\032\002\010\001\022\022\n\nTENSO" +
      "RFLOW\020\001\032\002\010\001\022\r\n\005OTHER\020\002\032\002\010\001B\003\370\001\001b\006proto3"
    };
    ...
    internal_static_tensorflow_serving_ModelConfig_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_tensorflow_serving_ModelConfig_descriptor,
        new String[] { "Name", "BasePath", "ModelType", "ModelPlatform", "ModelVersionPolicy", "LoggingConfig", });
    internal_static_tensorflow_serving_ModelConfigList_descriptor =
