...
public final class LogCollectorConfigOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected FieldAccessorTable
      ...
      return LogCollectorConfigOuterClass.internal_static_tensorflow_serving_LogCollectorConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              LogCollectorConfig.class, Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof LogCollectorConfig)) {
        return super.equals(obj);
      }
      LogCollectorConfig other = (LogCollectorConfig) obj;
    ...
    public static LogCollectorConfig parseFrom(
    ...
    public static LogCollectorConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static LogCollectorConfig parseFrom(
    ...
    public static LogCollectorConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static LogCollectorConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static LogCollectorConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(LogCollectorConfig prototype) {
    ...
    public static final class Builder extends
      ...
      @Override
      public LogCollectorConfig getDefaultInstanceForType() {
        return LogCollectorConfig.getDefaultInstance();
      }

      @Override
      public LogCollectorConfig build() {
        LogCollectorConfig result = buildPartial();
      ...
      @Override
      public LogCollectorConfig buildPartial() {
        LogCollectorConfig result = new LogCollectorConfig(this);
        result.type_ = type_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof LogCollectorConfig) {
          return mergeFrom((LogCollectorConfig)other);
        } else {
      ...
      public Builder mergeFrom(LogCollectorConfig other) {
        if (other == LogCollectorConfig.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        LogCollectorConfig parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (LogCollectorConfig) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final LogCollectorConfig DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new LogCollectorConfig();
    }

    public static LogCollectorConfig getDefaultInstance() {
